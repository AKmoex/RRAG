...
python finetune_retriever.py \
    ...
    --train_batch_size 32 \
    --num_epoch 4 \
    --model_save_path ../output/mine/retrievers/nq10_bert
...
HF_ENDPOINT=https://hf-mirror.com python feature_extraction.py \
    --dataset_name nq_10 \
    --input_path 10_total_documents/nq-open-10_total_documents_gold_at_0.jsonl.gz \
    --save_path ../output/mine/features/nq-open-10_total_documents_gold_at_0_bert.pkl \
    --model_name google-bert/bert-base-uncased \
...
nohup python runner.py \
  ...
  --dataset_name nq_10 \
  --input_path output/mine/features/nq-open-10_total_documents_gold_at_0_bert.pkl \
  --model_name /home/akmoex/.cache/modelscope/hub/models/shakechen/Llama-2-7b-hf \
  --load_in_8bit \
  --use_training \
  --save_model \
  --output_dir output/mine/llama-2-7b \
  --freeze_llm \
  --num_k 10 \
  --use_rrag \
  --use_evaluation \
  --save_results \
  > output/mine/llama-2-7b/train.log 2>&1 &
